...
class FlightsTest < ApplicationSystemTestCase
  ...
  test "creating a Flight" do
    ...
    fill_in "Airplane_Type", with: @flight.airplane_type
    fill_in "Ariline_Name", with: @flight.airline_name
    fill_in "Flight_Code", with: @flight.flight_code
  ...
  test "updating a Flight" do
    ...
    fill_in "Airplane_Type", with: @flight.airplane_type
    fill_in "Airline_Name", with: @flight.airline_name
    fill_in "Flight_Code", with: @flight.flight_code
